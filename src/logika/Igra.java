...
*/
	...
	private Igralec cigavaVrsta(Vrsta vrsta) {
		...
		if (count_BELO == M) { return Igralec.BEL; }
		else if (count_CRNO == M) { return Igralec.CRN; }
		else { return null; }
	}
	...
	/**
	 * metoda veljavnostPoteze(Koordinati poteza) preveri, ce je poteza veljavna
	 * preveri, ce je polje prazno in ce sta koordinati X in Y med 0 in N
	 * @param poteza
	...
	/**
	 * metoda odigraj(Koordinati poteza) najprej preveri, ce je poteza veljavna 
	 * ce je, spremeni vrednost igralca na potezi ter ga nastavi na nasprotnika
	 * @param poteza
